...
<?php
	...
	$sql="SELECT $month from division1";
...
$sql="UPDATE division1 set $month=$month+1 where rollno=$s ";
mysqli_query($conn,$sql);
}
echo "For Feb";
$month1='feb';
$name1='abcd11';
$sql="select sum($month1) from division1 where name='abcd11'";
...
?>
<div class="container" align="center" style="align-content: center; padding-top: 0px;margin-top: 0px ">
	<h1>Mark attendance</h1>
	<p>Please mark attendance of the students.</p>
	<p>Date: <?php echo $_SESSION['date']?></p>
	<form name="formname" style="max-width: 620px; padding-top: 0px; margin-top: 0px; padding-bottom: 150px;" action="" method="post">	
		
    	   	<?php
    	   	$sql = "SELECT * from division1";
                    $result = mysqli_query($conn, $sql);
                    
                    echo "<table style='margin-top:0px; padding-top:0px;'>
                    	<tr>
                    		<th>Roll number</th>
                    		<th>Name</th>
                    		<th>Attendance</th>
